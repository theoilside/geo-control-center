...
export const CITY_PAGE = `${CITIES_PAGE}/:objectId`;

export const AIRPORTS_PAGE = `${DEFAULT_LAYOUT}/airports`;
export const AIRPORT_PAGE = `${AIRPORTS_PAGE}/:objectId`;

export const RAIL_STATIONS_PAGE = `${DEFAULT_LAYOUT}/rail_stations`;
export const RAIL_STATION_PAGE = `${RAIL_STATIONS_PAGE}/:objectId`;

export const METRO_STATIONS_PAGE = `${DEFAULT_LAYOUT}/metro_stations`;
export const METRO_STATION_PAGE = `${METRO_STATIONS_PAGE}/:objectId`;
